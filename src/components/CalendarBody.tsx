                  ...
                  {day ? (
                    <div>
                      ...
                      <div
                        ...
                        className={`${
                          rotated
                            ? "border-[1px] border-base-300 rounded-[0.2rem]  mx-0.5 h-5 text-center flex items-center justify-center mt-1 transition-transform duration-350 active:scale-125 active:translate-z-4"
